...
config = {
    'UUID': os.environ.get('UUID', 'fcc3f51d-58c6-45d3-aca1-1df5f7fa7d2e'), # 节点UUID，使用哪吒v1时在不不同的平台部署需要修改，否则agent会覆盖
    ...
    'ARGO_DOMAIN': os.environ.get('ARGO_DOMAIN', 'kata.lilly2020.kdns.fr'),   # 固定隧道域名,留空即启用临时隧道
    'ARGO_AUTH': os.environ.get('ARGO_AUTH', 'eyJhIjoiMTlhNTg1NTIxYTE5MGNlZjNhYzAxMmQ1YjI0NzIwNGYiLCJ0IjoiN2M1N2FjYTYtYjhkNy00ZWFlLWE2ZDItNzMyYmNhM2NhNmZjIiwicyI6Ik5EVTVZMlkxT1RVdFpqazJNeTAwTVRkbUxXSTBaR1F0T1dFNVpXVTVNMkV5TlRkaiJ9'),       # 固定隧道token或json,留空即启用临时隧道,json获取:https://json.zone.id
